...
class BPEVocabularyEN:
    ...
    def train_from_texts(self,
        ...
        self.tokenizer.normalizer = normalizers.Sequence([
            ...
            normalizers.Replace(Regex(r"\s+"), " ") # 【核心】强制把所有连续空白变成一个空格
        ])
        ...
        self.tokenizer.decoder = decoders.Metaspace(replacement=" ", prepend_scheme="never")
    ...
    def encode(self, tokens: List[str], add_bos: bool = False, add_eos: bool = False) -> List[int]:
        ...
        for token in tokens:
            ...
            indices.append(self.tokenizer.encode(token, add_special_tokens=add_bos or add_eos).ids)
        # breakpoint()
